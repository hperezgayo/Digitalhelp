...
CREATE TABLE `Usuario_resuelve_servicio` (
  `idUsuario_resuelve_servicio` int NOT NULL,
  `comentario` varchar(200) DEFAULT NULL,
  `fichero_resuelto` blob,
  `usuario` int DEFAULT NULL,
  `servicio` int DEFAULT NULL,
  PRIMARY KEY (`idUsuario_resuelve_servicio`),
  KEY `Usuarios_idx` (`idUsuario_resuelve_servicio`),
  CONSTRAINT `Usuarios` FOREIGN KEY (`idUsuario_resuelve_servicio`) REFERENCES `Servicio` (`idServicio`)
...
-- Dump completed on 2020-11-27 17:25:34
